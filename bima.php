...
<head>
    ...
    <title>Ruang Bima &mdash; OMBO</title>
    <style>
        .text-black-50 {
...
<body>
    ...
    <div class="hero page-inner overlay" style="background-image: url('images/bima1.jpg')">
        <div class="container">
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-9 text-center mt-5">
                    <h1 class="heading" data-aos="fade-up">Ruang Bima</h1>
                ...
                <div class="col-lg-7">
                    <div class="img-property-slide-wrap">
                        <div class="img-property-slide">
                            <img src="images/bima2.jpg" alt="Image" class="img-fluid" />
                            <img src="images/bima3.jpg" alt="Image" class="img-fluid" />
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <p class="text-black-50">
                        Ruang Bima adalah salah satu ruangan yang berada di SMK Negeri 2 Depok Sleman Yogyakarta. Ruang ini dinamakan Ruang Bima karena merupakan ruangan yang luas seperti tokoh Bima pada Pandawa yang merupakan salah satu Pandawa yang paling besar dan kuat. Ruang Bima ini terletak di sebelah WKS 4 Humas, yang berada di gerbang sebelah utara. Di dalam Ruang Bima ini terdapat panggung, 2 kamar mandi (perempuan dan laki-laki), alat karawitan, AC Floor Standing dan kipas, juga terdapat layar monitor. Ini adalah ruangan yang luas, ruangan ini bisa menampung 300-400 orang.
                    </p>
                    <h5>Tabel Peminjaman Ruang Bima</h5>
                    <div class="table-wrapper">
                      <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            // Query untuk mengambil data peminjaman ruang Bima
                            $sql = "SELECT * FROM bookings WHERE roomID = 1";
