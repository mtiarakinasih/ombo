...
<html lang="en">
  <head>
    ...
    <title>Ruang Nakula-Sadewa &mdash; OMBO</title>
    <style>
        .text-black-50 {
  ...
  <body>
    ...
    <div
      ...
      style="background-image: url('images/naksad1.jpg')"
    >
      <div class="container">
        <div class="row justify-content-center align-items-center">
          <div class="col-lg-9 text-center mt-5">
            <h1 class="heading" data-aos="fade-up">Ruang Nakula Sadewa</h1>
          ...
          <div class="col-lg-7">
            <div class="img-property-slide-wrap">
              <div class="img-property-slide">
                <img src="images/naksad2.jpg" alt="Image" class="img-fluid" />
                <img src="images/naksad3.jpg" alt="Image" class="img-fluid" />
              </div>
            </div>
          </div>
          <div class="col-lg-4">
            ...
            Ruang Nakula-Sadewa atau biasa disebut Ruang NakSad ini juga merupakan salah satu ruangan yang berada di SMK Negeri 2 Depok Sleman Yogyakarta. Ruangan ini dinamakan Ruang NakSad karena memiliki dua sisi yang bisa dipisahkan dengan batas ruang, seperti pada tokoh Pandawa Nakula-Sadewa merupakan 2 tokoh yang kembar. Ruang NakSad ini terletak di atas Ruang Yudhistira. Pada Ruang NakSad ini terdapat fasilitas 2 layar monitor (kanan dan kiri), AC, meja dan kursi, serta kamar mandi di bagian luar ruang, ruang ini cocok digunakan untuk pertemuan penting. Ruang NakSad bisa menampung sekitar 70 orang
            </p>
            <h5>Tabel Peminjaman Ruang Nakula-Sadewa</h5>
            <div class="table-wrapper">
              <table class="table table-striped">
                ...
                <tbody>
                    ...
                    $sql = "SELECT * FROM bookings WHERE roomID = 2";
