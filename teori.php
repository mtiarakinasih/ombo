...
<html lang="en">
  ...
  <body>
    ...
    <div
      ...
      style="background-image: url('images/rutor1.jpg')"
    >
      <div class="container">
    ...
    <div class="section">
      <div class="container">
          ...
          <div class="col-lg-7">
            <div class="img-property-slide-wrap">
              <div class="img-property-slide">
                <img src="images/rutor2.jpg" alt="Image" class="img-fluid" />
                <img src="images/rutor3.jpg" alt="Image" class="img-fluid" />
              </div>
            </div>
          </div>
          <div class="col-lg-4">
        ...
        .text-black-50 {
            ...
            Ruang Teori atau biasa disebut RuTor adalah tempat di SMK Negeri 2 Depok Sleman Yogyakarta yang terdapat kelas-kelas yang digunakan untuk pembelajaran dengan guru normatif. Di RuTor ini terdapat 25 ruang kelas yang bisa digunakan, beberapa gazebo, kamar mandi dan taman kecil. Setiap kelas di RuTor terdapat fasilitas meja kursi, layar monitor, papan tulis, kipas/AC. RuTor ini bisa digunakan untuk acara yang perlu menggunakan beberapa ruangan sekaligus. Satu kelas bisa menampung sekitar 35 orang.
            </p>

            <h5>Tabel Peminjaman Ruang Teori</h5>
            <div class="table-wrapper">
              <table class="table table-striped">
                ...
                <tbody>
                    ...
                    $sql = "SELECT * FROM bookings WHERE roomID = 6";
