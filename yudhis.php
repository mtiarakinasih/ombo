...
<html lang="en">
  ...
  <body>
    ...
    <div class="hero page-inner overlay" style="background-image: url('images/yudhis1_new.jpg')">
      <div class="container">
          ...
          <div class="col-lg-7">
            <div class="img-property-slide-wrap">
              <div class="img-property-slide">
                <img src="images/yudhis2.jpg" alt="Image" class="img-fluid" />
                <img src="images/yudhis3.jpg" alt="Image" class="img-fluid" />
                <img src="images/yudhis4.jpg" alt="Image" class="img-fluid" />
              </div>
            </div>
          </div>
          <div class="col-lg-4">
            <p class="text-black-50">
            Ruang Yudhistira adalah salah satu ruangan yang berada di SMK Negeri 2 Depok Sleman Yogyakarta. Ruang Yudhistira ini berada di depan Ruang TU (tata usaha) dan menghadap ke arah selatan. Ruang TU (tata usaha) berada di sebelah ruang WKS 4 Humas. Ruangan ini mempunyai fasilitas layar monitor, meja dan kursi, AC. Ruangan ini bisa menampung sekitar 15-50 orang. Ruang Yudhistira ini cocok digunakan untuk rapat penting ataupun seminar.
            </p>
            <h5>Tabel Peminjaman Ruang Yudhistira</h5>
            <div class="table-wrapper">
              <table class="table table-striped">
                ...
                <tbody>
                    ...
                    $sql = "SELECT * FROM bookings WHERE roomID = 3";
